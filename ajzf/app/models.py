...
house_facility = db.Table(
    ...
    db.Column("house_id", db.Integer, db.ForeignKey("t_house.id"), primary_key=True, nullable=False),  # 房屋编号
    db.Column("facility_id", db.Integer, db.ForeignKey("t_facility.id"), primary_key=True, nullable=False)  # 设施编号
)
...
class House(BaseModel, db.Model):
    ...
    # 归属地的区域编号
    area_id = db.Column(db.Integer, db.ForeignKey("t_area.id"), nullable=False)
...
class HouseImage(BaseModel, db.Model):
    ...
    # 房屋编号
    house_id = db.Column(db.Integer, db.ForeignKey("t_house.id"), nullable=False)
